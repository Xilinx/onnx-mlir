...
UNSUPPORTED_OPS(ONNXImageDecoderOp)
...
UNSUPPORTED_OPS(ONNXRegexFullMatchOp)
...
UNSUPPORTED_OPS(ONNXStringConcatOp)
UNSUPPORTED_OPS(ONNXStringNormalizerOp)
UNSUPPORTED_OPS(ONNXStringSplitOp)
UNSUPPORTED_OPS(ONNXTfIdfVectorizerOp)
UNSUPPORTED_OPS(ONNXTreeEnsembleOp)
