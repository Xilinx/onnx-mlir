...
void addXmcMlirPasses(mlir::OpPassManager &pm, OnnxToMlirOptions opts) {
  ...
  pm.addNestedPass<func::FuncOp>(onnx_mlir::createReplaceQDQReduceL2Pass());
  ...
  pm.addNestedPass<func::FuncOp>(onnx_mlir::createFuseReshapePairsPass());
  ...
  pm.addNestedPass<func::FuncOp>(
      onnx_mlir::createQuantizeConcatConstInputPass());
  pm.addNestedPass<func::FuncOp>(
