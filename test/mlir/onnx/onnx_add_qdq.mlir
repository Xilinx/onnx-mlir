...
func.func @test_inserted_qdq(%arg0: tensor<2x2xf32>) -> tensor<2x2xf32> {
  ...
  %init_div = onnx.Constant dense<4.0> : tensor<f32>
  ...
  %2 = "onnx.Sub"(%0, %init) : (tensor<2x2xf32>, tensor<f32>) -> tensor<2x2xf32>
  ...
  %5 = "onnx.Div"(%4, %init_div) : (tensor<2x2xf32>, tensor<f32>) -> tensor<2x2xf32>
  %6 = "onnx.Add"(%1, %2) : (tensor<2x2xf32>, tensor<2x2xf32>) -> tensor<2x2xf32>
