...
// CHECK:       %[[COSG:.*]] = "onnx.Gather"(%[[COS]], %[[POS]]) {axis = 0 : si64} : (tensor<4096x48xf32>, tensor<1x128xi64>) -> tensor<1x128x48xf32>
// CHECK:       %[[SING:.*]] = "onnx.Gather"(%[[SIN]], %[[POS]]) {axis = 0 : si64} : (tensor<4096x48xf32>, tensor<1x128xi64>) -> tensor<1x128x48xf32>
// CHECK:       %[[RQ:.*]] = "onnx.RotaryEmbedding"(%[[SPLIT]]#0, %[[COSG]], %[[SING]], %{{.*}}) {interleaved = 0 : si64, num_heads = 32 : si64, rotary_embedding_dim = 0 : si64} : (tensor<1x128x3072xf32>, tensor<1x128x48xf32>, tensor<1x128x48xf32>, none) -> tensor<1x128x3072xf32>
// CHECK:       %[[RK:.*]] = "onnx.RotaryEmbedding"(%[[SPLIT]]#1, %[[COSG]], %[[SING]], %{{.*}}) {interleaved = 0 : si64, num_heads = 16 : si64, rotary_embedding_dim = 0 : si64} : (tensor<1x128x1536xf32>, tensor<1x128x48xf32>, tensor<1x128x48xf32>, none) -> tensor<1x128x1536xf32>
// CHECK:       %[[MASK:.*]] = "onnx.Where"({{.*}}) : (tensor<1x1x128x384xi1>, tensor<f32>, tensor<f32>) -> tensor<1x1x128x384xf32>
...
// CHECK:       %[[COSG:.*]] = "onnx.Gather"(%[[COS]], %[[POS]]) {axis = 0 : si64} : (tensor<4096x48xf32>, tensor<1x128xi64>) -> tensor<1x128x48xf32>
// CHECK:       %[[SING:.*]] = "onnx.Gather"(%[[SIN]], %[[POS]]) {axis = 0 : si64} : (tensor<4096x48xf32>, tensor<1x128xi64>) -> tensor<1x128x48xf32>
// CHECK:       %[[RQ:.*]] = "onnx.RotaryEmbedding"(%[[Q]], %[[COSG]], %[[SING]], %{{.*}}) {interleaved = 1 : si64, num_heads = 32 : si64, rotary_embedding_dim = 0 : si64} : (tensor<1x128x3072xf32>, tensor<1x128x48xf32>, tensor<1x128x48xf32>, none) -> tensor<1x128x3072xf32>
// CHECK:       %[[RK:.*]] = "onnx.RotaryEmbedding"(%[[K]], %[[COSG]], %[[SING]], %{{.*}}) {interleaved = 1 : si64, num_heads = 16 : si64, rotary_embedding_dim = 0 : si64} : (tensor<1x128x1536xf32>, tensor<1x128x48xf32>, tensor<1x128x48xf32>, none) -> tensor<1x128x1536xf32>
// CHECK:       %[[MASK:.*]] = "onnx.Where"({{.*}}) : (tensor<1x1x128x384xi1>, tensor<f32>, tensor<f32>) -> tensor<1x1x128x384xf32>
...
// CHECK:       %[[COSG:.*]] = "onnx.Gather"(%[[COS]], %[[POS]]) {axis = 0 : si64} : (tensor<4096x48xf32>, tensor<4x128xi64>) -> tensor<4x128x48xf32>
// CHECK:       %[[SING:.*]] = "onnx.Gather"(%[[SIN]], %[[POS]]) {axis = 0 : si64} : (tensor<4096x48xf32>, tensor<4x128xi64>) -> tensor<4x128x48xf32>
// CHECK:       %[[RQ:.*]] = "onnx.RotaryEmbedding"(%[[Q]], %[[COSG]], %[[SING]], %{{.*}}) {interleaved = 0 : si64, num_heads = 32 : si64, rotary_embedding_dim = 0 : si64} : (tensor<4x128x3072xf32>, tensor<4x128x48xf32>, tensor<4x128x48xf32>, none) -> tensor<4x128x3072xf32>
// CHECK:       %[[RK:.*]] = "onnx.RotaryEmbedding"(%[[K]], %[[COSG]], %[[SING]], %{{.*}}) {interleaved = 0 : si64, num_heads = 16 : si64, rotary_embedding_dim = 0 : si64} : (tensor<4x128x1536xf32>, tensor<4x128x48xf32>, tensor<4x128x48xf32>, none) -> tensor<4x128x1536xf32>
...
// CHECK:       %[[COSG:.*]] = "onnx.Gather"(%[[COS]], %[[POS]]) {axis = 0 : si64} : (tensor<4096x48xf32>, tensor<1x128xi64>) -> tensor<1x128x48xf32>
// CHECK:       %[[SING:.*]] = "onnx.Gather"(%[[SIN]], %[[POS]]) {axis = 0 : si64} : (tensor<4096x48xf32>, tensor<1x128xi64>) -> tensor<1x128x48xf32>
// CHECK:       %[[RQ:.*]] = "onnx.RotaryEmbedding"(%[[Q]], %[[COSG]], %[[SING]], %{{.*}}) {interleaved = 0 : si64, num_heads = 32 : si64, rotary_embedding_dim = 0 : si64} : (tensor<1x128x3072xf32>, tensor<1x128x48xf32>, tensor<1x128x48xf32>, none) -> tensor<1x128x3072xf32>
// CHECK:       %[[RK:.*]] = "onnx.RotaryEmbedding"(%[[K]], %[[COSG]], %[[SING]], %{{.*}}) {interleaved = 0 : si64, num_heads = 16 : si64, rotary_embedding_dim = 0 : si64} : (tensor<1x128x1536xf32>, tensor<1x128x48xf32>, tensor<1x128x48xf32>, none) -> tensor<1x128x1536xf32>
// CHECK:       %[[MASK:.*]] = "onnx.Where"({{.*}}) : (tensor<1x1x128x128xi1>, tensor<f32>, tensor<f32>) -> tensor<1x1x128x128xf32>
