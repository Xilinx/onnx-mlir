...
func.func @test_convtrans_stride_5_unsupported(%arg0: tensor<1x64x200xf32>, %arg1: tensor<64x24x10xf32>) -> tensor<1x24x1001xf32> {    
  %0 = "onnx.Constant" () { value= dense<0.02> : tensor<24xf32>} : ()-> tensor<24xf32>
...
// CHECK-LABEL:   test_convtrans_stride_5_unsupported
// CHECK:           onnx.ConvTranspose
// DISABLED-LABEL: test_convtrans_stride_5_unsupported
// DISABLED: onnx.ConvTranspose
