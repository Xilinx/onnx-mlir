...
// CHECK: %[[XFE_CONV:.*]] = "onnx.XFEConv"(%[[RESHAPE1_OUT]], %[[CONV_WEIGHT]], %{{.*}}) {activation = "NONE", dilations = [1, 1], group = 1 : si64, onnx_node_name = "MatMul_1", pads = [0, 0, 0, 0], strides = [1, 1]} : (tensor<1x1x1x64x!quant.uniform<u8:f32, 2.500000e-01>>, tensor<32x1x1x64x!quant.uniform<u8:f32, 2.500000e-01>>, none) -> tensor<1x1x1x32x!quant.uniform<u8:f32, 2.500000e-01>>
...
// CHECK: %[[XFE_CONV:.*]] = "onnx.XFEConv"(%[[RESHAPE1_OUT]], %[[CONV_WEIGHT]], %{{.*}}) {activation = "NONE", dilations = [1, 1], group = 1 : si64, onnx_node_name = "/fc/Gemm", pads = [0, 0, 0, 0], strides = [1, 1]}
...
// CHECK: %[[XFE_CONV:.*]] = "onnx.XFEConv"(%[[RESHAPE1_OUT]], %[[CONV_WEIGHT]], %{{.*}}) {activation = "NONE", dilations = [1, 1], group = 1 : si64, onnx_node_name = "/fc/Gemm_0", pads = [0, 0, 0, 0], strides = [1, 1]}
