...
func.func @test_xfe_conv_channel_last_basic(%arg0: tensor<1x28x28x3xf32>, %arg1: tensor<64x3x3x3xf32>, %arg2: tensor<64xf32>) -> tensor<*xf32> {
  ...
  // CHECK: [[RES:%.+]] = "onnx.XFEConv"(%arg0, %arg1, %arg2) {activation = "NONE", dilations = [1, 1], group = 1 : si64, pads = [0, 0, 0, 0], strides = [1, 1]} : (tensor<1x28x28x3xf32>, tensor<64x3x3x3xf32>, tensor<64xf32>) -> tensor<1x26x26x64xf32>
...
func.func @test_xfe_conv_channel_last_padded(%arg0: tensor<1x28x28x3xf32>, %arg1: tensor<64x3x3x3xf32>, %arg2: tensor<64xf32>) -> tensor<*xf32> {
  ...
  // CHECK: [[RES:%.+]] = "onnx.XFEConv"(%arg0, %arg1, %arg2) {activation = "NONE", dilations = [1, 1], group = 1 : si64, pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x28x28x3xf32>, tensor<64x3x3x3xf32>, tensor<64xf32>) -> tensor<1x28x28x64xf32>
...
func.func @test_xfe_conv_channel_last_strided(%arg0: tensor<1x28x28x3xf32>, %arg1: tensor<64x3x3x3xf32>, %arg2: tensor<64xf32>) -> tensor<*xf32> {
  ...
  // CHECK: [[RES:%.+]] = "onnx.XFEConv"(%arg0, %arg1, %arg2) {activation = "NONE", dilations = [1, 1], group = 1 : si64, pads = [0, 0, 0, 0], strides = [2, 2]} : (tensor<1x28x28x3xf32>, tensor<64x3x3x3xf32>, tensor<64xf32>) -> tensor<1x13x13x64xf32>
...
func.func @test_xfe_conv_channel_last_1d(%arg0: tensor<2x128x16xf32>, %arg1: tensor<32x5x16xf32>, %arg2: tensor<32xf32>) -> tensor<*xf32> {
  ...
  // CHECK: [[RES:%.+]] = "onnx.XFEConv"(%arg0, %arg1, %arg2) {activation = "NONE", dilations = [1], group = 1 : si64, pads = [0, 0], strides = [1]} : (tensor<2x128x16xf32>, tensor<32x5x16xf32>, tensor<32xf32>) -> tensor<2x124x32xf32>
...
func.func @test_xfe_conv_channel_last_3d(%arg0: tensor<1x8x16x16x3xf32>, %arg1: tensor<64x3x3x3x3xf32>, %arg2: tensor<64xf32>) -> tensor<*xf32> {
  ...
  // CHECK: [[RES:%.+]] = "onnx.XFEConv"(%arg0, %arg1, %arg2) {activation = "NONE", dilations = [1, 1, 1], group = 1 : si64, pads = [0, 0, 0, 0, 0, 0], strides = [1, 1, 1]} : (tensor<1x8x16x16x3xf32>, tensor<64x3x3x3x3xf32>, tensor<64xf32>) -> tensor<1x6x14x14x64xf32>
