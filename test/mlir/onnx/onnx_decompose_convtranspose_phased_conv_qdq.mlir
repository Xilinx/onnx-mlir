...
// CHECK:           %[[VAL_28:.*]] = "onnx.DequantizeLinear"(%[[VAL_27]], %[[VAL_26]], %[[VAL_24]]) {axis = 1 : si64} : (tensor<32xi8>, tensor<f32>, tensor<i8>) -> tensor<32xf32>
// CHECK:           %[[VAL_29:.*]] = "onnx.QuantizeLinear"(%[[VAL_0]], %[[VAL_22]], %[[VAL_24]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x128x10x16xf32>, tensor<f32>, tensor<i8>) -> tensor<1x128x10x16xi8>
// CHECK:           %[[VAL_30:.*]] = "onnx.DequantizeLinear"(%[[VAL_29]], %[[VAL_22]], %[[VAL_24]]) {axis = 1 : si64} : (tensor<1x128x10x16xi8>, tensor<f32>, tensor<i8>) -> tensor<1x128x10x16xf32>
...
// CHECK:           %[[VAL_41:.*]] = "onnx.DequantizeLinear"(%[[VAL_40]], %[[VAL_23]], %[[VAL_24]]) {axis = 1 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
...
// CHECK:           %[[VAL_43:.*]] = "onnx.DequantizeLinear"(%[[VAL_37]], %[[VAL_23]], %[[VAL_24]]) {axis = 1 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
...
// CHECK:           %[[VAL_45:.*]] = "onnx.DequantizeLinear"(%[[VAL_38]], %[[VAL_23]], %[[VAL_24]]) {axis = 1 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
...
// CHECK:           %[[VAL_47:.*]] = "onnx.DequantizeLinear"(%[[VAL_39]], %[[VAL_23]], %[[VAL_24]]) {axis = 1 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
...
// CHECK:           %[[VAL_57:.*]] = "onnx.QuantizeLinear"(%[[VAL_56]], %[[VAL_21]], %[[VAL_24]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x32x20x32xf32>, tensor<f32>, tensor<i8>) -> tensor<1x32x20x32xi8>
// CHECK:           %[[VAL_58:.*]] = "onnx.DequantizeLinear"(%[[VAL_57]], %[[VAL_21]], %[[VAL_24]]) {axis = 1 : si64} : (tensor<1x32x20x32xi8>, tensor<f32>, tensor<i8>) -> tensor<1x32x20x32xf32>
...
// CONSTPROP:           %[[VAL_22:.*]] = "onnx.DequantizeLinear"(%[[VAL_21]], %[[VAL_20]], %[[VAL_19]]) {axis = 1 : si64} : (tensor<32xi8>, tensor<f32>, tensor<i8>) -> tensor<32xf32>
// CONSTPROP:           %[[VAL_23:.*]] = "onnx.QuantizeLinear"(%[[VAL_0]], %[[VAL_17]], %[[VAL_19]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x128x10x16xf32>, tensor<f32>, tensor<i8>) -> tensor<1x128x10x16xi8>
// CONSTPROP:           %[[VAL_24:.*]] = "onnx.DequantizeLinear"(%[[VAL_23]], %[[VAL_17]], %[[VAL_19]]) {axis = 1 : si64} : (tensor<1x128x10x16xi8>, tensor<f32>, tensor<i8>) -> tensor<1x128x10x16xf32>
// CONSTPROP:           %[[VAL_25:.*]] = "onnx.DequantizeLinear"(%[[VAL_1]], %[[VAL_18]], %[[VAL_19]]) {axis = 1 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
...
// CONSTPROP:           %[[VAL_27:.*]] = "onnx.DequantizeLinear"(%[[VAL_4]], %[[VAL_18]], %[[VAL_19]]) {axis = 1 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
...
// CONSTPROP:           %[[VAL_29:.*]] = "onnx.DequantizeLinear"(%[[VAL_3]], %[[VAL_18]], %[[VAL_19]]) {axis = 1 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
...
// CONSTPROP:           %[[VAL_31:.*]] = "onnx.DequantizeLinear"(%[[VAL_2]], %[[VAL_18]], %[[VAL_19]]) {axis = 1 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
...
// CONSTPROP:           %[[VAL_41:.*]] = "onnx.QuantizeLinear"(%[[VAL_40]], %[[VAL_16]], %[[VAL_19]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x32x20x32xf32>, tensor<f32>, tensor<i8>) -> tensor<1x32x20x32xi8>
// CONSTPROP:           %[[VAL_42:.*]] = "onnx.DequantizeLinear"(%[[VAL_41]], %[[VAL_16]], %[[VAL_19]]) {axis = 1 : si64} : (tensor<1x32x20x32xi8>, tensor<f32>, tensor<i8>) -> tensor<1x32x20x32xf32>
...
// CHECK:           %[[VAL_21:.*]] = "onnx.DequantizeLinear"(%[[VAL_20]], %[[VAL_19]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256xi8>, tensor<f32>, tensor<i8>) -> tensor<256xf32>
// CHECK:           %[[VAL_22:.*]] = "onnx.QuantizeLinear"(%[[VAL_0]], %[[VAL_15]], %[[VAL_17]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x512x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x512x5x21xi8>
// CHECK:           %[[VAL_23:.*]] = "onnx.DequantizeLinear"(%[[VAL_22]], %[[VAL_15]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<1x512x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x512x5x21xf32>
...
// CHECK:           %[[VAL_33:.*]] = "onnx.DequantizeLinear"(%[[VAL_32]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CHECK:           %[[VAL_35:.*]] = "onnx.DequantizeLinear"(%[[VAL_29]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CHECK:           %[[VAL_37:.*]] = "onnx.DequantizeLinear"(%[[VAL_30]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CHECK:           %[[VAL_39:.*]] = "onnx.DequantizeLinear"(%[[VAL_31]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CHECK:           %[[VAL_45:.*]] = "onnx.QuantizeLinear"(%[[VAL_44]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x10x42xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xi8>
// CHECK:           %[[VAL_46:.*]] = "onnx.DequantizeLinear"(%[[VAL_45]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<1x256x10x42xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xf32>
...
// CONSTPROP:           %[[VAL_13:.*]] = "onnx.DequantizeLinear"(%[[VAL_12]], %[[VAL_11]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256xi8>, tensor<f32>, tensor<i8>) -> tensor<256xf32>
// CONSTPROP:           %[[VAL_14:.*]] = "onnx.QuantizeLinear"(%[[VAL_0]], %[[VAL_8]], %[[VAL_10]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x512x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x512x5x21xi8>
// CONSTPROP:           %[[VAL_15:.*]] = "onnx.DequantizeLinear"(%[[VAL_14]], %[[VAL_8]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<1x512x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x512x5x21xf32>
// CONSTPROP:           %[[VAL_16:.*]] = "onnx.DequantizeLinear"(%[[VAL_1]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CONSTPROP:           %[[VAL_18:.*]] = "onnx.DequantizeLinear"(%[[VAL_4]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CONSTPROP:           %[[VAL_20:.*]] = "onnx.DequantizeLinear"(%[[VAL_3]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CONSTPROP:           %[[VAL_22:.*]] = "onnx.DequantizeLinear"(%[[VAL_2]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CONSTPROP:           %[[VAL_28:.*]] = "onnx.QuantizeLinear"(%[[VAL_27]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x10x42xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xi8>
// CONSTPROP:           %[[VAL_29:.*]] = "onnx.DequantizeLinear"(%[[VAL_28]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<1x256x10x42xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xf32>
...
// CHECK:           %[[VAL_36:.*]] = "onnx.DequantizeLinear"(%[[VAL_29]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CHECK:           %[[VAL_39:.*]] = "onnx.DequantizeLinear"(%[[VAL_30]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
// CHECK:           %[[VAL_40:.*]] = "onnx.Conv"(%[[VAL_23]], %[[VAL_39]], %[[VAL_21]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x5x21xf32>, tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x5x21xf32>
// CHECK:           %[[VAL_41:.*]] = "onnx.Relu"(%[[VAL_40]]) : (tensor<1x256x5x21xf32>) -> tensor<1x256x5x21xf32>
// CHECK:           %[[VAL_42:.*]] = "onnx.DequantizeLinear"(%[[VAL_31]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CHECK:           %[[VAL_49:.*]] = "onnx.QuantizeLinear"(%[[VAL_48]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x10x42xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xi8>
// CHECK:           %[[VAL_50:.*]] = "onnx.DequantizeLinear"(%[[VAL_49]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<1x256x10x42xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xf32>
...
// CONSTPROP:           %[[VAL_19:.*]] = "onnx.DequantizeLinear"(%[[VAL_4]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CONSTPROP:           %[[VAL_22:.*]] = "onnx.DequantizeLinear"(%[[VAL_3]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
// CONSTPROP:           %[[VAL_23:.*]] = "onnx.Conv"(%[[VAL_15]], %[[VAL_22]], %[[VAL_13]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x5x21xf32>, tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x5x21xf32>
// CONSTPROP:           %[[VAL_24:.*]] = "onnx.Relu"(%[[VAL_23]]) : (tensor<1x256x5x21xf32>) -> tensor<1x256x5x21xf32>
// CONSTPROP:           %[[VAL_25:.*]] = "onnx.DequantizeLinear"(%[[VAL_2]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CONSTPROP:           %[[VAL_32:.*]] = "onnx.QuantizeLinear"(%[[VAL_31]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x10x42xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xi8>
// CONSTPROP:           %[[VAL_33:.*]] = "onnx.DequantizeLinear"(%[[VAL_32]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<1x256x10x42xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xf32>
...
// CHECK:           %[[VAL_33:.*]] = "onnx.DequantizeLinear"(%[[VAL_32]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
// CHECK:           %[[VAL_34:.*]] = "onnx.Conv"(%[[VAL_23]], %[[VAL_33]], %[[VAL_21]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x5x21xf32>, tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x5x21xf32>
// CHECK:           %[[VAL_35:.*]] = "onnx.QuantizeLinear"(%[[VAL_34]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xi8>
// CHECK:           %[[VAL_36:.*]] = "onnx.DequantizeLinear"(%[[VAL_35]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<1x256x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xf32>
// CHECK:           %[[VAL_37:.*]] = "onnx.Relu"(%[[VAL_36]]) : (tensor<1x256x5x21xf32>) -> tensor<1x256x5x21xf32>
// CHECK:           %[[VAL_38:.*]] = "onnx.DequantizeLinear"(%[[VAL_29]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CHECK:           %[[VAL_40:.*]] = "onnx.QuantizeLinear"(%[[VAL_39]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xi8>
// CHECK:           %[[VAL_41:.*]] = "onnx.DequantizeLinear"(%[[VAL_40]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<1x256x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xf32>
// CHECK:           %[[VAL_42:.*]] = "onnx.Relu"(%[[VAL_41]]) : (tensor<1x256x5x21xf32>) -> tensor<1x256x5x21xf32>
// CHECK:           %[[VAL_43:.*]] = "onnx.DequantizeLinear"(%[[VAL_30]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CHECK:           %[[VAL_45:.*]] = "onnx.QuantizeLinear"(%[[VAL_44]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xi8>
// CHECK:           %[[VAL_46:.*]] = "onnx.DequantizeLinear"(%[[VAL_45]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<1x256x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xf32>
// CHECK:           %[[VAL_47:.*]] = "onnx.Relu"(%[[VAL_46]]) : (tensor<1x256x5x21xf32>) -> tensor<1x256x5x21xf32>
// CHECK:           %[[VAL_48:.*]] = "onnx.DequantizeLinear"(%[[VAL_31]], %[[VAL_16]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CHECK:           %[[VAL_50:.*]] = "onnx.QuantizeLinear"(%[[VAL_49]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xi8>
// CHECK:           %[[VAL_51:.*]] = "onnx.DequantizeLinear"(%[[VAL_50]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<1x256x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xf32>
...
// CHECK:           %[[VAL_57:.*]] = "onnx.QuantizeLinear"(%[[VAL_56]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x10x42xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xi8>
// CHECK:           %[[VAL_58:.*]] = "onnx.DequantizeLinear"(%[[VAL_57]], %[[VAL_14]], %[[VAL_17]]) {axis = 1 : si64} : (tensor<1x256x10x42xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xf32>
...
// CONSTPROP:           %[[VAL_16:.*]] = "onnx.DequantizeLinear"(%[[VAL_1]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
// CONSTPROP:           %[[VAL_17:.*]] = "onnx.Conv"(%[[VAL_15]], %[[VAL_16]], %[[VAL_13]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x5x21xf32>, tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x5x21xf32>
// CONSTPROP:           %[[VAL_18:.*]] = "onnx.QuantizeLinear"(%[[VAL_17]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xi8>
// CONSTPROP:           %[[VAL_19:.*]] = "onnx.DequantizeLinear"(%[[VAL_18]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<1x256x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xf32>
// CONSTPROP:           %[[VAL_20:.*]] = "onnx.Relu"(%[[VAL_19]]) : (tensor<1x256x5x21xf32>) -> tensor<1x256x5x21xf32>
// CONSTPROP:           %[[VAL_21:.*]] = "onnx.DequantizeLinear"(%[[VAL_4]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CONSTPROP:           %[[VAL_23:.*]] = "onnx.QuantizeLinear"(%[[VAL_22]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xi8>
// CONSTPROP:           %[[VAL_24:.*]] = "onnx.DequantizeLinear"(%[[VAL_23]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<1x256x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xf32>
// CONSTPROP:           %[[VAL_25:.*]] = "onnx.Relu"(%[[VAL_24]]) : (tensor<1x256x5x21xf32>) -> tensor<1x256x5x21xf32>
// CONSTPROP:           %[[VAL_26:.*]] = "onnx.DequantizeLinear"(%[[VAL_3]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CONSTPROP:           %[[VAL_28:.*]] = "onnx.QuantizeLinear"(%[[VAL_27]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xi8>
// CONSTPROP:           %[[VAL_29:.*]] = "onnx.DequantizeLinear"(%[[VAL_28]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<1x256x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xf32>
// CONSTPROP:           %[[VAL_30:.*]] = "onnx.Relu"(%[[VAL_29]]) : (tensor<1x256x5x21xf32>) -> tensor<1x256x5x21xf32>
// CONSTPROP:           %[[VAL_31:.*]] = "onnx.DequantizeLinear"(%[[VAL_2]], %[[VAL_9]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<256x512x3x3xi8>, tensor<f32>, tensor<i8>) -> tensor<256x512x3x3xf32>
...
// CONSTPROP:           %[[VAL_33:.*]] = "onnx.QuantizeLinear"(%[[VAL_32]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x5x21xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xi8>
// CONSTPROP:           %[[VAL_34:.*]] = "onnx.DequantizeLinear"(%[[VAL_33]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<1x256x5x21xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x5x21xf32>
...
// CONSTPROP:           %[[VAL_40:.*]] = "onnx.QuantizeLinear"(%[[VAL_39]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64, saturate = 1 : si64} : (tensor<1x256x10x42xf32>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xi8>
// CONSTPROP:           %[[VAL_41:.*]] = "onnx.DequantizeLinear"(%[[VAL_40]], %[[VAL_7]], %[[VAL_10]]) {axis = 1 : si64} : (tensor<1x256x10x42xi8>, tensor<f32>, tensor<i8>) -> tensor<1x256x10x42xf32>
