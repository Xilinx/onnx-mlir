...
func.func @test_gather_axis0neg_i16(%arg0 : tensor<3x2xf32>) -> tensor<2x2x2xf32> {
...
// CHECK-LABEL:  func.func @test_gather_axis0neg_i16
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<3x2xf32>) -> tensor<2x2x2xf32> {
// CHECK-DAG:       [[VAR_0_:%.+]] = stablehlo.constant dense<{{.}}[0, -1], [1, 2]{{.}}> : tensor<2x2xi16>
// CHECK-DAG:       [[VAR_1_:%.+]] = stablehlo.constant dense<0> : tensor<2x2xi16>
// CHECK-DAG:       [[VAR_2_:%.+]] = stablehlo.constant dense<3> : tensor<2x2xi16>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_3_:%.+]] = stablehlo.compare  LT, [[VAR_0_]], [[VAR_1_]] : (tensor<2x2xi16>, tensor<2x2xi16>) -> tensor<2x2xi1>
// CHECK-DAG:       [[VAR_4_:%.+]] = stablehlo.add [[VAR_0_]], [[VAR_2_]] : tensor<2x2xi16>
// CHECK:           [[VAR_5_:%.+]] = stablehlo.select [[VAR_3_]], [[VAR_4_]], [[VAR_0_]] : tensor<2x2xi1>, tensor<2x2xi16>
// CHECK:           [[VAR_6_:%.+]] = "stablehlo.torch_index_select"([[PARAM_0_]], [[VAR_5_]]) <{batch_dims = 0 : i64, dim = 0 : i64}> : (tensor<3x2xf32>, tensor<2x2xi16>) -> tensor<2x2x2xf32>
// CHECK:           return [[VAR_6_]] : tensor<2x2x2xf32>
// CHECK:         }
