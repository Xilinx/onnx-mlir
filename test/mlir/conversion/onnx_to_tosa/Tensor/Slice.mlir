...
// CHECK: %0 = "tosa.const"() <{value = dense<[0, 1, 0, 5]> : tensor<4xi64>}> : () -> tensor<4xi64>
...
// CHECK: %0 = "tosa.const"() <{value = dense<[0, 6, 0, 0]> : tensor<4xi64>}> : () -> tensor<4xi64>
// CHECK: %1 = "tosa.const"() <{value = dense<0.000000e+00> : tensor<f32>}> : () -> tensor<f32>
// CHECK: %2 = tosa.pad %arg0, %0, %1 : (tensor<9x30xf32>,  tensor<4xi64>, tensor<f32>) -> tensor<15x30xf32>
...
// CHECK: %0 = "tosa.const"() <{value = dense<[0, 0, 0, 1, 0, 1, 0, 0]> : tensor<8xi64>}> : () -> tensor<8xi64>
// CHECK: %1 = "tosa.const"() <{value = dense<0.000000e+00> : tensor<f32>}> : () -> tensor<f32>
// CHECK: %2 = tosa.pad %arg0, %0, %1 : (tensor<1x56x56x92xf32>, tensor<8xi64>, tensor<f32>) -> tensor<1x57x57x92xf32>
